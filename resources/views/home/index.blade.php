       ...
       <span class="col-left catlist-style2">
          ...
          <article class="home-blog-entry clr">
           ...
           <div class="postlist-meta">
            ...
            <div class="postlist-meta-like like-btn" style="float:right;" uid="{{session()->get('homeuser')->user_id}}" artid="{{ $n->art_id }}" title="点击喜欢">
             <i class="fa fa-heart"></i>&nbsp;
             <span>{{ $n->art_love }}</span>&nbsp;
            </div>
            <div class="postlist-meta-collect collect collect-no" uid="{{session()->get('homeuser')->user_id}}" artid="{{ $n->art_id }}" style="float:right;cursor:default;" title="必须登录才能收藏">
            
             <i class="fa fa-star"></i>&nbsp;
             <span>{{ $n->art_collect }}人已收藏</span>&nbsp;
            </div>
           </div>
