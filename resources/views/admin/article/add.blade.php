...
<html>
  ...
  <body>
    <div class="x-body">
        <form action="{{url('/article')}}" method="post" id="art_form" class="layui-form layui-form-pane">
            {{csrf_field()}}
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="cate_id">
                          @foreach($cates as $v)
                            <option value="{{$v['cate_id']}}" @if($v['cate_pid']==0) disabled @endif>{{$v['cate_name']}}</option>
                          @endforeach
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="art_title"  
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="art_tag" 
                        autocomplete="off" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" id="desc" name="art_description" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <label for="desc" class="layui-form-label">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="name" name="art_editor"
                        autocomplete="off" class="layui-input">
                        <input type="hidden" name="art_time" value="{{time()}}">
                    </div>
                </div>
                <div class="layui-form-item">
